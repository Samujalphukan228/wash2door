        ...
        >
          ...
          <span
            className="tracking-[0.2em] uppercase text-white/60
                       ...
                       border-b border-transparent group-hover:border-white/30"
            style={{ fontSize: "10px" }}
          >
            {item.label}
          </span>
...
export default function TopBar() {
  ...
  // Shared structure — used by both SSR and client
  ...
  return (
    ...
    >
      {/* Left fade */}
      <div
        className="absolute left-0 top-0 bottom-0 w-10 sm:w-14
                   bg-gradient-to-r from-black to-transparent z-10 pointer-events-none"
        aria-hidden="true"
      />
      {/* Right fade */}
      <div
        className="absolute right-0 top-0 bottom-0 w-10 sm:w-14
                   bg-gradient-to-l from-black to-transparent z-10 pointer-events-none"
        aria-hidden="true"
      />

      {/* Marquee track */}
      <div
        className={prefersReduced || !mounted ? "flex" : "flex topbar-marquee"}
      >
        {marqueeContent}
      </div>
