...
function StatusBadge({ label }) {
  return (
    <motion.div
      ...
      className="flex items-center gap-2 px-3 py-1.5 md:px-3.5 md:py-2 border border-white/10
                 rounded-full bg-white/[0.04] backdrop-blur-md shrink-0"
    >
      <PulsingDot />
      <span
        className="tracking-[0.15em] md:tracking-[0.2em] uppercase text-white/60 whitespace-nowrap text-[8px] md:text-[9px]"
      >
        {label}
      </span>
    </motion.div>
  ...
  return (
    <motion.a
      ...
      className={`group relative inline-flex items-center justify-center gap-3
                  px-6 py-3.5 md:px-8 md:py-4 border border-white/15 overflow-hidden rounded-[4px]
    ...
    >
      ...
      />
      <span
        className="relative z-10 tracking-[0.15em] md:tracking-[0.2em] uppercase text-white
                   group-hover:text-neutral-950 transition-colors duration-500
                   text-[10px] md:text-[10.5px] font-medium"
      >
        Book Now
      </span>
      <ArrowUpRight
  ...
  return (
    <motion.a
      ...
      className={`group inline-flex items-center gap-2.5 py-3
                  text-white/35 hover:text-emerald-400
                  transition-colors duration-300 ${fullWidth ? "justify-center w-full" : ""}`}
    ...
    >
      ...
      />
      <span className="tracking-[0.15em] md:tracking-[0.18em] uppercase text-[9px] md:text-[10px]">
        WhatsApp Us
      </span>
    </motion.a>
  )
...
function StatItem({ value, label, align = "left", delay = 0 }) {
  return (
    ...
    >
      ...
      <p
        className="tracking-[0.2em] md:tracking-[0.25em] uppercase text-white/30 mt-1 md:mt-1.5 text-[7px] md:text-[8px]"
      >
        {label}
      </p>
    </motion.div>
...
function HeadlineBlock({ size = "mobile", sectionRef }) {
  ...
  return (
    <motion.div
      style={{ opacity, y }}
      className={size === "desktop" ? "mb-10 lg:mb-14" : "mb-6"}
    >
        ...
        >
          <h1
            className={`will-change-transform ${
              italic ? "text-white/45 italic" : "text-white"
            }`}
            style={{
...
function ServiceLink({ service, index }) {
  return (
    <motion.a
      ...
      className="tracking-[0.15em] md:tracking-[0.2em] uppercase text-white/25
                 hover:text-white/60 transition-colors duration-300 group text-[8px] md:text-[9px]"
    >
      {service}
      <span
        className="block h-px bg-white/30 w-0 group-hover:w-full
...
export default function Hero() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full h-screen min-h-[600px] max-h-[1200px] overflow-hidden bg-neutral-950"
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(to bottom, transparent 10%, rgba(255,255,255,0.08) 25%, rgba(255,255,255,0.08) 75%, transparent 90%)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 h-full flex flex-col md:hidden px-5 pt-5 pb-8">
        ...
        <div className="shrink-0">
          ...
          >
            <p
              className="text-white/40 leading-[1.75] mb-6 max-w-[300px] text-[12px] tracking-wide"
            >
      ...
      <div className="relative z-10 h-full hidden md:flex flex-col px-10 lg:px-16 xl:px-24 py-8 lg:py-10">
        ...
        <header className="flex items-center justify-between shrink-0">
          ...
          >
            ...
            <span
              className="tracking-[0.25em] uppercase text-white/45 text-[10px] lg:text-[11px]"
              style={{ fontFamily: "Georgia, serif" }}
            >
          ...
          <div className="w-full max-w-[1400px]">
            ...
            >
              ...
              <div className="flex items-end gap-6 lg:gap-8">
                {/* Vertical line */}
                <div
                  className="w-px h-16 lg:h-20 shrink-0 bg-gradient-to-b from-white/10 to-transparent"
                  aria-hidden="true"
                />
                <div>
                  <p
                    className="tracking-wide text-white/40 leading-[1.85] mb-6 max-w-sm lg:max-w-md text-[11px] lg:text-[12px]"
                  >
        ...
        <footer className="shrink-0">
          <motion.div
            ...
            className="w-full h-px bg-white/[0.08] mb-4 lg:mb-5 origin-left"
            aria-hidden="true"
          />
          <motion.div
            variants={fadeIn}
          ...
          >
            ...
            <motion.a
              href="/Services"
              whileHover={{ x: 3 }}
              className="flex items-center gap-3 text-white/30 hover:text-white/60
                         transition-colors duration-300 group"
            >
              <span className="tracking-[0.2em] uppercase text-[8px] lg:text-[9px]">
                All Services
              </span>
              <span
                className="h-px bg-current w-4 group-hover:w-8
