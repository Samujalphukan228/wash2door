...
import { ArrowRight, Phone, Droplets, Shield, Clock } from "lucide-react"
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ═══════════ MOBILE + TABLET (< lg) ═══════════ */}
      <div className="relative z-10 min-h-[100svh] flex flex-col lg:hidden px-4 sm:px-6">
        {/* ── Header ── */}
        <div className="flex items-center justify-between pt-4 pb-2 shrink-0">
          ...
          >
            ...
            <span
              ...
              style={{ fontSize: "7px", fontFamily: SANS, fontWeight: 500 }}
            >
              Wash2Door
            </span>
          </motion.div>
        ...
        <div className="shrink-0 pb-6">
          ...
          <motion.p
            ...
            className="text-white/35 leading-[1.7] mb-5"
            style={{
              fontSize: "11px",
              fontFamily: SANS,
              maxWidth: "280px",
          ...
          >
            ...
            <a
              ...
              className="flex items-center justify-center w-12 h-12 rounded-full border border-white/10 bg-white/[0.04] text-white/40 active:bg-white/10 transition-colors duration-200"
              aria-label="WhatsApp"
            >
          ...
          >
            {STATS.map((stat, i) => (
              <motion.div
                ...
                className="flex-1 p-3 rounded-xl border border-white/[0.06] bg-white/[0.02]"
              >
                <p
      ...
      {/* ═══════════ DESKTOP (>= lg) ═══════════ */}
      <div className="relative z-10 min-h-[100svh] hidden lg:flex flex-col px-12 xl:px-20 2xl:px-28 py-8">
        {/* ── Top Bar ── */}
        <div className="flex items-center justify-between shrink-0">
          ...
          >
            <div className="w-7 h-7 rounded-full border border-white/15 flex items-center justify-center">
              <Droplets size={11} className="text-white/30" />
            </div>
        ...
        <div className="shrink-0 pb-6">
          ...
          <div className="flex items-end justify-between gap-12 xl:gap-16 mb-12">
            {/* Headline */}
            ...
            >
              ...
              <p
                className="text-white/30 leading-[1.75] mb-6"
                style={{ fontSize: "12px", fontFamily: SANS, letterSpacing: "0.01em" }}
              >
              ...
              <div className="flex flex-col gap-2.5">
                ...
                >
                  ...
                  <div className="relative z-10 w-7 h-7 rounded-full bg-black flex items-center justify-center group-hover:rotate-[-45deg] transition-transform duration-400">
                    <ArrowRight size={12} className="text-white" />
                  </div>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-center gap-2.5 h-11 rounded-full border border-white/[0.08] bg-white/[0.02] text-white/30 hover:text-white/50 hover:border-white/12 hover:bg-white/[0.04] transition-all duration-400"
                >
            ...
            <div className="flex items-end justify-between">
                ...
                {STATS.map((stat, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="group px-4 xl:px-5 py-3 rounded-xl border border-white/[0.05] bg-white/[0.015] hover:bg-white/[0.03] hover:border-white/[0.08] transition-all duration-400 cursor-default"
                    >
              ...
              >
                {["Services", "About", "Contact"].map((link) => (
                  ...
                  >
                    <span
                      className="text-white/20 group-hover:text-white/45 tracking-[0.2em] uppercase transition-colors duration-300"
                      style={{ fontSize: "7px", fontFamily: SANS }}
                    >
                      {link}
                    </span>
