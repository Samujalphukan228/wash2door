  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="max-w-6xl mx-auto px-8 md:px-16 py-6"
      >
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <a href="https://nexxupp.com" className="no-underline">
            <p
              className="tracking-[0.2em] uppercase text-white/20 text-center hover:text-white/40 transition-colors duration-300"
              style={{ fontSize: 'clamp(9px, 2.2vw, 10px)' }}
            >
              Made by Nexxupp
            </p>
