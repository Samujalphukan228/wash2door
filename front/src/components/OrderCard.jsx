...
const OrderCard = memo(function OrderCard({
  ...
  return (
    ...
    >
      {isUpcoming && (
        <div className="absolute top-3 right-3 h-1.5 w-1.5">
      ...
      >
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <InfoRow icon={Calendar} label="Booking ID" value={bookingCode} />
            <InfoRow icon={Calendar} label="Reference" value={_id.slice(-8)} />
          </div>

          {/* Schedule */}
          <div>
            <p className="text-[8px] font-semibold text-gray-600 uppercase mb-2">Schedule</p>
            <InfoRow icon={Calendar} label="Date" value={formatDate(bookingDate)} />
            <InfoRow icon={Clock} label="Time" value={timeSlot} />
            <InfoRow icon={Timer} label="Duration" value={`${duration}m`} />
          </div>
