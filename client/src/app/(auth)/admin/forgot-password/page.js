        ...
        <div className="min-h-screen bg-white flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-black flex-col justify-between p-16">
                ...
                <div>
                    ...
                    >
                        Password<br /><em>recovery.</em>
                    </h1>
                    <div className="space-y-5 max-w-xs">
                        {[
                            { num: '01', text: 'Enter your admin email address' },
                            { num: '02', text: 'Check your inbox for reset link' },
                            { num: '03', text: 'Create your new secure password' },
                        ].map((step) => (
                            <div key={step.num} className="flex items-start gap-4">
                                <span className="text-neutral-600 text-xs tracking-widest mt-0.5 shrink-0">
                                    {step.num}
                                </span>
                    ...
                    {!sent ? (
                        ...
                        <div>
                            <div className="mb-10">
                                ...
                                <p className="text-black text-sm font-medium mt-1">{email}</p>
                            </div>

                            <div className="border-l-2 border-black pl-4 mb-10">
                                <p className="text-neutral-500 text-xs leading-relaxed">
                                    The link expires in 1 hour. Check your spam folder
