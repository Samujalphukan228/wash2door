...
import { X, Loader2, Upload, ChevronLeft, Check } from 'lucide-react';
                ...
                ">
                    ...
                    <div className="shrink-0 flex items-center gap-3 px-4 py-4 border-b border-white/[0.06]">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm font-medium text-white mt-0.5">Create Category</p>
                        </div>
                        <button
                            onClick={onClose}
                            className="w-8 h-8 rounded-lg flex items-center justify-center border border-white/[0.08] bg-white/[0.02] text-gray-500 hover:text-white transition-all"
                        ...
                        <FieldGroup label="Category Image">
                            <div className="flex items-start gap-3">
                                {imagePreview ? (
                                    ...
                                    <label className="w-20 h-16 border border-dashed border-white/[0.12] hover:border-white/[0.2] rounded-xl flex flex-col items-center justify-center cursor-pointer transition-all shrink-0 bg-white/[0.02]">
