...
const STATUS_CONFIG = {
    confirmed: {
        ...
        icon: '✓',
        activeBg:   'bg-blue-500/[0.08] border-blue-500/20',
    ...
    completed: {
        ...
        icon: '✓',
        activeBg:   'bg-emerald-500/[0.08] border-emerald-500/20',
    ...
    cancelled: {
        ...
        icon: '✕',
        activeBg:   'bg-red-500/[0.08] border-red-500/20',
    ...
    return (
        ...
        >
            ...
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center text-sm font-bold shrink-0 transition-all ${
                isSelected
                    ? `${config.iconBg} ${config.activeText}`
...
export default function UpdateStatusModal({ booking, onClose, onSuccess }) {
    ...
    const handleSubmit = useCallback(async () => {
        ...
        try {
            ...
            toast.success(
                selectedStatus === 'completed' ? 'Booking completed!' : `Booking ${selectedStatus}`
            );
            onClose();
                ...
                <div className="flex-1 overflow-y-auto overscroll-contain px-4 py-3 space-y-3">
                    {availableStatuses.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-10">
                            ...
                            <p className="text-[11px] text-white/40 mb-0.5">No changes available</p>
                ...
                <div className="shrink-0 p-3 border-t border-white/[0.06]">
                    <div className="flex gap-2">
                        <button
                            onClick={onClose}
                            disabled={loading}
                            className="px-4 py-2.5 rounded-lg border border-white/[0.06] bg-white/[0.02] text-xs text-white/40 hover:text-white/60 hover:bg-white/[0.04] transition-all disabled:opacity-50"
                        >
                            Cancel
                        </button>
                        <button
