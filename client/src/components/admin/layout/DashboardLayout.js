...
// ✅ OPTIMIZED: Simplified animation variants - GPU accelerated only
...
// ✅ OPTIMIZED: Removed blur filter, using GPU-accelerated transforms only
...
// ✅ OPTIMIZED: Simpler item animations
...
// ✅ OPTIMIZED: Faster backdrop animation
    ...
    return (
        <button
            ...
            className={`
                ...
                transition-colors duration-100 select-none active:scale-95
            ...
            <motion.div variants={POPOVER_ITEM_VARIANTS}>
                <Link href={route.href} onClick={onClose}>
                    ...
                    >
                        ...
                        <ChevronRight
                            className={`w-3.5 h-3.5 transition-transform duration-100 group-hover:translate-x-0.5 ${
                                active
                                    ? 'text-black/50'
            ...
            >
                ...
                <motion.button
                    ...
                    className="w-7 h-7 flex items-center justify-center rounded-lg bg-white/[0.03] 
                               hover:bg-white/[0.08] active:scale-90 transition-all duration-100"
                        ...
                        return (
                            <Link
                                ...
                                className={`
                                    ...
                                    whitespace-nowrap transition-colors duration-100 shrink-0
                                    ${isActive
                                        ? 'bg-white text-black'
        ...
        <div className="min-h-screen bg-black">
            ...
            <div className="lg:pl-[220px] flex flex-col min-h-screen">
                ...
                <main
                    ...
                    style={{
                        paddingBottom: 'calc(5.5rem + max(0px, env(safe-area-inset-bottom)))',
                    }}
                >
            ...
            <AnimatePresence mode="sync">
                {menuOpen && (
                    <MenuBackdrop key="menu-backdrop" onClose={closeMenu} />
                )}
            </AnimatePresence>
